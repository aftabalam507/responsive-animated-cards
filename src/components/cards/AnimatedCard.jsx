  ...
  return (
    <>
      <div className="container mx-auto">
        ...
        md:grid-cols-3 place-items-center gap-6"
        >
          {CardsData.map(({ id, img, title, desc }) => (
            ...
            >
              ...
              <div
                className="absolute left-0 top-[-100%] opacity-0 
              group-hover:opacity-100 
              group-hover:top-[0] p-4 w-full h-full bg-black/60
              ...
              >
                <div className="space-y-4">
                  <Slide cascade>
                    ...
                    <div>
                      <button className="border border-white px-4 rounded-lg hover:bg-black/20 duration-300">
                        View
                      </button>
                    </div>
                  </Slide>
